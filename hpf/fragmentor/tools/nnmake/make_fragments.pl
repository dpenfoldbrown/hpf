...
#  CVS information:
#  $Revision: 19024 $
#  $Date: 2007-12-10 18:01:36 -0500 (Mon, 10 Dec 2007) $
#  $Author: tex $
...
my $PSIBLAST = "/Users/tex/src/blast/bin/blastpgp";     # PSI-BLAST (duh.)
...
my $MAKEMAT = "/Users/tex/src/blast/bin/makemat";       # makemat utility (part of NCBI tools)
my $PSIPRED = "/Users/tex/src/psipred/bin/psipred";       # psipred
my $PSIPASS2 = "/Users/tex/src/psipred/bin/psipass2";     # psipass2 (part of psipred pkg)
my $PSIPRED_DATA = "/Users/tex/src/psipred/data";         # dir containing psipred data files.
...
my $NNMAKE = "./nnmake++.exe";                         # nnmake binary  (cvs respository 'nnmake')
my $TRIMLOOPS = "$src_dir/nnmake/trimLoopLibrary.pl";                  # trimLoopLibrary.pl (cvs respository 'nnmake')

# chemshift
my $CHEMSHIFT = "$src_dir/chemshift/pCHEMSHIFT.pgi";     # chemshift binary (cvs repository 'chemshift')
...
my $SAM_target99		= "$shareware_dir/sam3.5.i686-linux/bin/target99";	# sam target99 executable
my $SAM_uniqueseq		= "$shareware_dir/sam3.5.i686-linux/bin/uniqueseq";	# sam uniqueseq executable
