...
def setup_scoped(db='hpf'):
    """
    Description of scoped session: http://docs.sqlalchemy.org/en/rel_0_7/orm/session.html#unitofwork-contextual
    """
    global engine, Base
    if engine == None:
...
Psipred.sequence = relation(Sequence, primaryjoin="Sequence.id==Psipred.sequence_key", backref=backref("psipred",uselist=True,order_by=Psipred.ginzu_version.desc()))
